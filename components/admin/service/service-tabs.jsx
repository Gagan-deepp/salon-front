...
import BulkServiceUpload from "@/components/bulk/bulk-service"
import { Scissors, FileUp } from "lucide-react"

export function ServiceTabs({ children }) {
    return (
        <Tabs defaultValue="services" className="w-full">
            ...
            <TabsContent value="services" className="mt-6 animate-in fade-in-50 duration-200">
                {children}
            </TabsContent>
