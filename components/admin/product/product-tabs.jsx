...
import BulkProductUpload from "@/components/bulk/bulk-product"
import { Package, FileUp } from "lucide-react"

export function ProductTabs({ children }) {
    return (
        <Tabs defaultValue="products" className="w-full">
            ...
            <TabsContent value="products" className="mt-6 animate-in fade-in-50 duration-200">
                {children}
            </TabsContent>
