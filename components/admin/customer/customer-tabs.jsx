...
import BulkCustomerUpload from "@/components/bulk/bulk-customer"
import { Users, FileUp } from "lucide-react"

export function CustomerTabs({ children }) {
    return (
        <Tabs defaultValue="customers" className="w-full">
            ...
            <TabsContent value="customers" className="mt-6 animate-in fade-in-50 duration-200">
                {children}
            </TabsContent>
